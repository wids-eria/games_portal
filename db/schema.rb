...
#   Unknown type 'json' for column 'last_result'
  ...
  add_index "guild_ownerships", ["guild_id", "user_id"], :name => "index_guild_ownerships_on_guild_id_and_user_id", :unique => true
  ...
  add_index "guild_users", ["guild_id", "user_id"], :name => "index_guild_users_on_guild_id_and_user_id", :unique => true
